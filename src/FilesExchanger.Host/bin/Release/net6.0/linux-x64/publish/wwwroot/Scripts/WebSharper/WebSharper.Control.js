...
{
 "use strict";
 var WebSharper,Control,Observer,Message,HotStream,HotStream$1,Observable,Microsoft,FSharp,Control$1,ObservableModule,Event,Event$1,DelegateEvent,DelegateEvent$1,Obj,FSharpEvent,FSharpDelegateEvent,EventModule,MailboxProcessor,Runtime,Util,List,Seq,Unchecked,Arrays,Concurrency,TimeoutException,Operators,Collections,LinkedList;
 ...
 {
  Obj.New.call(this);
  this.event=Event$1.New(Runtime.MarkResizable([]));
 },FSharpEvent);
 ...
 {
  Obj.New.call(this);
  this.event=DelegateEvent$1.New(Runtime.MarkResizable([]));
 },FSharpDelegateEvent);
 ...
 EventModule.Pairwise=function(e)
 {
  var buf,ev;
  buf=[null];
  ev=Event$1.New(Runtime.MarkResizable([]));
 ...
 {
  var r;
  r=Event$1.New(Runtime.MarkResizable([]));
 ...
 MailboxProcessor=Control.MailboxProcessor=Runtime.Class({
   ...
   return Concurrency.Delay(function()
   {
    ...
    function a(ok)
    {
     ...
     function scanNext()
     {
      ...
      $this.savedCont={
       $:1,
       $0:(_$1=null,Concurrency.Delay(function()
       {
        var m$3;
     ...
     if(timeout$1<0)
      {
       $this.savedCont={
        $:1,
        $0:(_=null,Concurrency.Delay(function()
        {
         ok({
          $:1,
          $0:$this.dequeue()
  ...
  Start:function()
  {
   ...
   if(this.started)
    ...
    {
     this.started=true;
     $this.startAsync((_=null,Concurrency.Delay(function()
     {
