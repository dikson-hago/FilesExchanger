(function(Global)
{
 ...
 SendFileJsModule.Run$15$20=function(sendFileResponse)
 {
  return function(e)
  {
   ...
   Concurrency.StartImmediate((_=null,Concurrency.Delay(function()
   {
    ...
    {
     return Concurrency.Bind((new AjaxRemotingProvider.New()).Async("FilesExchanger.Host:FilesExchanger.Host.InternalContext.SendFilesHandler.Send:1496817080",[filePath]),function(a)
     {
 ...
 DownloadFileJsModule.Run$15$22=function(downloadResult)
 {
  return function(e)
  {
   ...
   Concurrency.StartImmediate((_=null,Concurrency.Delay(function()
   {
    ...
    return Concurrency.Bind((new AjaxRemotingProvider.New()).Async("FilesExchanger.Host:FilesExchanger.Host.Handlers.DownloadFilesHandler.DownloadFile:1496817080",[filePath]),function(a)
    {
 ...
 DeviceNameJsModule.Run$15$32=function(deviceName)
 {
  return function()
  {
   ...
   Concurrency.StartImmediate((_=null,Concurrency.Delay(function()
   {
    return Concurrency.Bind((new AjaxRemotingProvider.New()).Async("FilesExchanger.Host:FilesExchanger.Host.Handlers.GenerateDeviceNameHandler.GetName:430832026",[]),function(a)
    {
 ...
 FirstConnectionForReceiveJsModule.Run$15$28=function(connectionStatus)
 {
  return function()
  {
   ...
   Concurrency.StartImmediate((_=null,Concurrency.Delay(function()
   {
    return Concurrency.TryWith(Concurrency.Delay(function()
    {
     return Concurrency.Bind((new AjaxRemotingProvider.New()).Async("FilesExchanger.Host:FilesExchanger.Host.Handlers.FirstConnectionForReceiveHandler.Connect:430832026",[]),function(a)
     {
 ...
 FirstConnectionForSendJsModule.Run$15$24=function(testConnectionResponse)
 {
  return function(e)
  {
   ...
   Concurrency.StartImmediate((_=null,Concurrency.Delay(function()
   {
    ...
    return Concurrency.TryWith(Concurrency.Delay(function()
    {
     return Concurrency.Bind((new AjaxRemotingProvider.New()).Async("FilesExchanger.Host:FilesExchanger.Host.Handlers.FirstConnectionForSendHandler.Connect:1496817080",[externalDeviceName]),function(a)
     {
