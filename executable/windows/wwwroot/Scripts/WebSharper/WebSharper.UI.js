...
{
 "use strict";
 var WebSharper,UI,Array,String,List,Abbrev,Fresh,HashSet,Dict,Obj,Slot,Async,Mailbox,SC$1,AppendList,SC$2,DomUtility,SC$3,Trie,LookupResult,SC$4,Snap,Var,View,ConcreteVar,Var$1,Updates,FromView,ViewBuilder,Submitter,Key,Model,Serializer,Storage,ArrayStorage,LocalStorageBackend,ListModel,ListModels,SC$5,ReactiveExtensions,DoubleInterpolation,Interpolation,Easing,Easings,An,Anims,Trans,SC$6,Web,Control,OnAfterRenderControl,AnimatedAttrNode,DynamicAttrNode,AttrProxy,Client,Attrs,Dyn,Attrs$1,CheckedInput,BindVar,AttrModule,SC$7,FSharpInlineControl,InlineControlWithPlaceHolder,Settings,DocElemNode,Docs,DomNodes,NodeSet,RunState,Docs$1,Doc,Elt,EltUpdater,SC$8,Templates,Prepare,SC$9,Flow,FlowBuilder,HtmlModule,attr,Router,Route,Routing,RouteMap,Input,MousePosSt,MouseBtnSt,Mouse,KeyListenerSt,Keyboard,SC$10,List$1,Arrays,Enumerator,Strings,Char,Collections,HashSet$1,Seq,Runtime,Unchecked,console,Concurrency,Map,FSharpMap,Operators,Queue,Lazy,Dictionary,JSON,Numeric,Node,Slice,Sitelets,RouterModule,Route$1,Utils,Option;
 ...
 Templates.InlineTemplate=function(el,fillWith)
 {
  ...
  Templates.foreachNotPreserved(el,"[ws-onafterrender]",function(e$1)
  {
   ...
   if(m[0])
    m[1].$==7?(e$1.removeAttribute("ws-onafterrender"),addAttr(e$1,AttrModule.OnAfterRender(m[1].$1))):m[1].$==8?(e$1.removeAttribute("ws-onafterrender"),addAttr(e$1,AttrModule.OnAfterRender(m[1].$1))):console.warn("onafterrender hole filled with non-onafterrender data",name);
  });
  Templates.foreachNotPreserved(el,"[ws-var]",function(e$1)
  {
   ...
   if(m[0])
    m[1].$==10?addAttr(e$1,AttrModule.Value(m[1].$1)):m[1].$==11?addAttr(e$1,AttrModule.Checked(m[1].$1)):m[1].$==12?addAttr(e$1,AttrModule.IntValue(m[1].$1)):m[1].$==13?addAttr(e$1,AttrModule.IntValueUnchecked(m[1].$1)):m[1].$==14?addAttr(e$1,AttrModule.FloatValue(m[1].$1)):m[1].$==15?addAttr(e$1,AttrModule.FloatValueUnchecked(m[1].$1)):console.warn("Var hole filled with non-Var data",name);
  });
